  ...
  return <div className={`bg-white p-3 rounded-lg cursor-pointer group ${isSubReply ? 'mb-1' : 'mb-4'} `}>
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3 mt-1.5">
                            {!isSubReply && (
                                <>
                                    <button
                                        className="flex items-center gap-2 text-[13px] font-medium text-sky-950 bg-sky-50 px-4 py-1 rounded-full hover:bg-sky-500 hover:text-white cursor-pointer "
                                    ...
                                    >
                                        ...
                                        <LuChevronDown className={`${showSubReplies ? "rotate-180" : ""}`} />
                                    </button>{" "}
                                </>
                            )}
        ...
        {!isSubReply && showReplyForm && (
            <CommentReplyInput 
                ...
                handleCancleReply={handleCancleReply}
            />
        )}
            ...
            replies.map((comment, index) => (
                ...
                >
                    <CommentInfoCard 
                        ...
                        isSubReply
                        updatedOn={
                            comment.updatedAt ? moment(comment.updatedAt).format("Do MMM YYYY") : "-"
                        }
