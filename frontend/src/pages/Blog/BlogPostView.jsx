...
const BlogPostView = () => {
  ...
  const incrementViews = async(postId) => {
    ...
    try {
      const response = await axiosInstance.post(API_PATHS.POSTS.INCREMENT_VIEW(postId));
    ...
    <BlogLayout>
      {blogPostData && (
        <>
          ...
          <div className='grid grid-cols-12 gap-8 relative lg:px-16'>
            {/* added for desktop lg:px-16 */}
